...
There is script that can be used to update icons, [./build/update-icon-theme.js](https://github.com/microsoft/vscode/blob/HEAD/build/update-icon-theme.js).
...
There is a [`./icons/preview.html`](https://github.com/microsoft/vscode/blob/HEAD/icons/preview.html) file that can be opened to see all of the icons included in the theme.
